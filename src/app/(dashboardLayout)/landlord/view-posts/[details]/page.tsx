...
const PostDetailsPage = () => {
    ...
    const { formData, clearForm, updateFormData, updateLocation, updateMap, updateFeatures, setFormData } = useUpdateost()
            ...
            try {
                ...
                if (result?.success) {
                    ...
                    reset({
                        ...
                        location: {
                            division: postData?.location?.division || "",
                            district: postData?.location?.district || "",
                            subDistrict: postData?.location?.subDistrict || "",
                            streetAddress: postData?.location?.streetAddress || "",
                            map: {
                                lat: postData?.location?.map?.lat || 0,
                                lng: postData?.location?.map?.lng || 0,
                            },
                        },
    ...
    const subDistrict = watch("location.subDistrict");
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [divisionData, division, district, subDistrict, id]);
                    ...
                    <CardContent className='pt-2'>
                        <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold text-gray-700 border-b pb-2">Update Information</h3>
