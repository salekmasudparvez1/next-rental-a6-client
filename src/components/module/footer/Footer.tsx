...
const Footer = () => {
  return (
    <footer className=" w-full rounded-t-md rounded-b-none  max-w-[1130px] mx-auto  overflow-hidden border border-neutral-200 bg-transparent px-3 font-medium text-neutral-600 transition-all duration-100 [box-shadow:3px_3px_3px_rgb(82_82_82)]">
      {/* Main Footer Content */}
